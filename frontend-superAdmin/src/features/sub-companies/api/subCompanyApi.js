...
export const updateSubCompanyFixLimit = (id, fixLimit) => api.patch(`/sub-companies/${id}/fix-limit`, { fixLimit }).then((response) => response.data);
export const deleteSubCompany = (id) => api.delete(`/sub-companies/${id}`).then((response) => response.data);
